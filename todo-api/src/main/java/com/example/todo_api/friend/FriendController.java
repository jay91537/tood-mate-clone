...
public class FriendController {
    ...
    @PostMapping
    public ResponseEntity<Void> createFriend(@RequestBody @Valid FriendCreateRequest request) throws Exception {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<Member>> getFriendList(@RequestBody @Valid Long memberId) throws Exception {
